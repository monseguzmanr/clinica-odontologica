      ...
      .then((data) => {
        ...
        for (turno of data) {
          ...
          turnoRow.innerHTML =
            ...
            "</td>" +
            '<td>' +
            turno.odontologoTurnoSalidaDto.id +
            "</td>" +
            '<td>' +
            turno.odontologoTurnoSalidaDto.nombre + ' ' + turno.odontologoTurnoSalidaDto.apellido +
            "</td>" +
            '<td>' +
            turno.pacienteTurnoSalidaDto.id +
            "</td>" +
            '<td>' +
            turno.pacienteTurnoSalidaDto.nombre + ' ' + turno.pacienteTurnoSalidaDto.apellido +
            "</td>" +
            "<td>" +
            updateButton +
            "</td>" +
